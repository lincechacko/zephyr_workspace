...
const uintptr_t __irq_vector_table _irq_vector_table[57] = {
...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[57] = {
	...
	{(const void *)0x800400c, (ISR)0x8000f99}, /* 6 */
	{(const void *)0x800400a, (ISR)0x8000f99}, /* 7 */
	{(const void *)0x8004008, (ISR)0x8000f99}, /* 8 */
	{(const void *)0x8004006, (ISR)0x8000f99}, /* 9 */
	{(const void *)0x8004004, (ISR)0x8000f99}, /* 10 */
	...
	{(const void *)0x8004002, (ISR)0x8000f99}, /* 23 */
	...
	{(const void *)0x8004000, (ISR)0x8000f99}, /* 40 */
